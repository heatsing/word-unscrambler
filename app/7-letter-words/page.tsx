    ...
    <>
      <div className="container mx-auto px-4 pt-8">
        <div className="max-w-4xl mx-auto text-center mb-8">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">7 Letter Words</h1>
          <p className="text-lg text-muted-foreground">
            Complete list of {words.length} seven-letter words for high-scoring Scrabble plays
            and Words with Friends. Perfect for bingo bonuses!
          </p>
        </div>
      </div>
