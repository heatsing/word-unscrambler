...
import { WordUnscramblerTool } from "@/components/word-unscrambler-tool"
    ...
    <div className="container mx-auto px-4 py-12">
      <div className="max-w-6xl mx-auto">
        ...
        <article className="mt-12 space-y-10 text-muted-foreground max-w-3xl">
          ...
          <section>
            <h2 className="text-xl font-bold text-foreground mb-3">Benefits of Using Word Unscramble</h2>
            <p className="leading-relaxed mb-4">
